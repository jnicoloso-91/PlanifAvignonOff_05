...
#         # with col1:
#         typed = st.text_input("User ID :", value=proposed, width=200, ) #, label_visibility="collapsed")
#         show_user_link(typed)
#         # with col2:
#         go = st.button("Suivant")
...
def show_user_link(user_id):
    ...
    st.success("Voici votre lien personnel pour revenir plus tard :")
